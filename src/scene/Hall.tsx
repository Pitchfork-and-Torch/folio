...
export function Hall() {
  ...
  return (
    <group>
      ...
      <Rib z={-2.2} radius={3.05} />
      <Rib z={-6.4} radius={3.05} />
      <Rib z={-10.6} radius={3.05} />
      <Rib z={-15.5} radius={3.05} />
      <Rib z={-20.2} radius={3.05} />
      ...
      <Wall args={[2.9, 3.6, 0.24]} position={[5.2, 1.8, -13.8]} />
      <Wall args={[2.9, 3.6, 0.24]} position={[5.2, 1.8, -17.2]} />
      <Wall args={[0.24, 3.6, 3.6]} position={[6.65, 1.8, -15.5]} />

      <Wall args={[8.0, 4.1, 0.34]} position={[0, 2.05, -23.55]} color="#4a453e" />
      <Wall args={[0.34, 4.1, 12.0]} position={[-3.95, 2.05, -17.6]} />
      <Wall args={[0.34, 4.1, 2.4]} position={[3.95, 2.05, -12.6]} />
      <Wall args={[0.34, 4.1, 6.0]} position={[3.95, 2.05, -20.4]} />
    </group>
  );
}
