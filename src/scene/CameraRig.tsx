...
const KEYS: Key[] = [
  ...
  { t: 0.1, pos: [0.08, 1.5, 12.2], look: [-0.2, 1.48, 7.2] },
  { t: 0.23, pos: [1.55, 1.4, 6.35], look: [-2.05, 1.28, 6.35] },
  { t: 0.4, pos: [3.15, 2.15, -2.7], look: [3.15, 0.82, -4.85] },
  { t: 0.56, pos: [1.35, 1.48, -9.35], look: [-1.85, 1.22, -12.15] },
  { t: 0.74, pos: [1.45, 1.52, -13.05], look: [5.05, 1.08, -15.5] },
  { t: 1, pos: [0.0, 1.52, -17.6], look: [0.04, 1.58, -22.85] },
];
